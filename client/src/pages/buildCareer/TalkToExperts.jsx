...
import { useGetChatsQuery, useAddChatMutation } from "../../services/apiSlice";
import TalkToExpertsHeader from "./TalkToExpertsHeader";
	...
	return (
		<div>
			<div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
				<TalkToExpertsHeader />
				{chatInfo.isLoading ? (
					<span className="m-auto inline-block px-4 py-3">
					...
					>
						...
						{addChatInfo.isLoading && (
							<SingleChat
								text={text}
								index={chatInfo.data?.chats?.transcript.length}
							/>
						)}
					</div>
				)}
